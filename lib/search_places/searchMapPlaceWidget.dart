...
import 'package:pett_tagg/search_places/placeType.dart';
import 'package:pett_tagg/search_places/place.dart';
...
class _SearchMapPlaceWidgetState extends State<SearchMapPlaceWidget>
        ...
        child: Scaffold(
          body: SafeArea(
            child: _searchContainer(
              child: Container(
                height: 40,
                decoration: _placePredictions.length > 0
                    ? BoxDecoration()
                    : BoxDecoration(
  ...
  */
  InputDecoration _inputStyle() {
    ...
    //   hintStyle: TextStyle(
    //     color: widget.darkMode ? Colors.white[100] : Colors.white[850],
    //   ),
    // );
  }
  ...
  */
  ...
  Future<dynamic> _makeRequest(input) async {
    ...
    //String myUrl = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=-33.8670522,151.1957362&radius=1500&type=park&keyword=cruise&key=${widget.apiKey}";
